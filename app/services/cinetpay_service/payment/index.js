...
class TransactionInfo {
    ...
    constructor(Obj) {
        ...
        if(!this.notify_url) this.notify_url = 'http://localhost:3001/api/service/cinetpay_service/payment/notification';
        if(!this.return_url) this.return_url = 'http://localhost:3001/api/service/cinetpay_service/payment/notification';
